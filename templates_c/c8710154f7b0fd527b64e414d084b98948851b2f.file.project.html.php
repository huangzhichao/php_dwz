<?php /* Smarty version Smarty-3.1.16, created on 2015-04-09 13:54:48
         compiled from "view_html\project.html" */ ?>
<?php /*%%SmartyHeaderCode:254535513ab733e8836-60077585%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c8710154f7b0fd527b64e414d084b98948851b2f' => 
    array (
      0 => 'view_html\\project.html',
      1 => 1428558876,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '254535513ab733e8836-60077585',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_5513ab73496cd8_82628042',
  'variables' => 
  array (
    'param' => 0,
    'arr' => 0,
...
<?php if ($_valid && !is_callable('content_5513ab73496cd8_82628042')) {function content_5513ab73496cd8_82628042($_smarty_tpl) {?><script type="text/javascript">
...
<form id="pagerForm" method="post" action="view.php?p=project">
...
<div class="page">
	<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);" action="view.php?p=project" method="post">
...
" />
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="add" href="add.php?p=project" target="dialog"><span>添加</span></a></li>
				<li><a class="delete needid" href="del.php?p=project&id=" target="navTabTodo" title="确定要删除吗?"><span>删除</span></a></li>
				<li><a class="edit needid" id="update" href="update.php?p=project&id=" target="dialog" mask="true"><span>修改</span></a></li>
...
">
					...
					<td><?php echo $_smarty_tpl->tpl_vars['arr']->value[$_smarty_tpl->getVariable('smarty')->value['section']['n']['index']]['project_name'];?>
</td>
					<td><?php echo $_smarty_tpl->tpl_vars['arr']->value[$_smarty_tpl->getVariable('smarty')->value['section']['n']['index']]['project_manager'];?>
</td>
				</tr>
				<?php endfor; endif; ?>
			</tbody>
