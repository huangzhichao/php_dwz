<?php /* Smarty version Smarty-3.1.16, created on 2015-03-26 14:32:03
         compiled from "view_html\user.html" */ ?>
<?php /*%%SmartyHeaderCode:51915513a7e387c207-97677660%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '70940c7dd974d67bd36e22019482ed692fb0e162' => 
    array (
      0 => 'view_html\\user.html',
      1 => 1427351332,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '51915513a7e387c207-97677660',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5513a7e39198b9_30832538',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5513a7e39198b9_30832538')) {function content_5513a7e39198b9_30832538($_smarty_tpl) {?><script type="text/javascript">
...
<form id="pagerForm" method="post" action="view.php?p=user">
...
<div class="page">
	<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);" action="view.php?p=user" method="post">
...
" />
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="add" href="add.php?p=user" target="dialog"><span>添加</span></a></li>
				<li><a class="delete needid" href="del.php?p=user&id=" target="navTabTodo" title="确定要删除吗?"><span>删除</span></a></li>
				<!-- <li><a class="edit needid" id="update" href="update.php?p=user&id=" target="dialog" mask="true"><span>修改</span></a></li> -->
...
">
					...
					<td><?php echo $_smarty_tpl->tpl_vars['arr']->value[$_smarty_tpl->getVariable('smarty')->value['section']['n']['index']]['name'];?>
</td>
					<td><?php echo $_smarty_tpl->tpl_vars['arr']->value[$_smarty_tpl->getVariable('smarty')->value['section']['n']['index']]['username'];?>
</td>
				</tr>
				<?php endfor; endif; ?>
			</tbody>
